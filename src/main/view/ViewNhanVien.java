...
public class ViewNhanVien extends javax.swing.JFrame {
    ...
    private NhanVienResponse getFormData() {
        return new NhanVienResponse(txtMa.getText(),
                txtTen.getText(),
                (rdNam.isSelected() == true ? "Nam" : "Nữ"),
                txtSDT.getText(),
                txtDiaChi.getText(),
    ...
    private NhanVien convertResponseToEntity(NhanVienResponse response) {
        ...
        return new NhanVien
        (response.getMa(), response.getTen(),
                response.getGioiTinh(),response.getSdt(),
                response.getDiaChi(), cv.getId());
